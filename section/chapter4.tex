...
\begin{figure}[!hbtp]
\centering
\includegraphics[scale=0.3]{figures/cahyani1.jpg}
\caption{cahyani1}
\label{cahyani1}
\end{figure}
\par
...
\item Pada baris yang kedua yaitu untuk membuat variabel cahya_test dari variabel cahya_train dengan 50 data yang sisanya untuk data pada bagian testing yang dimana dimulai dari data ke 451 sampai akhir data 
\end{enumerate}
\item Hasil Dari Pemecahan Dataframe
\begin{figure}[!hbtp]
\centering
...
\begin{itemize}
\par Pot Confusion Matrix yaitu fungsi dari code tersebut  untuk mencetak dan memplot Confussion Matrix. Yang dimana normalisasi dapat diterapkan dengan mengaturnya seperti `normalize = True`.
...
\begin{figure}[!hbtp]
\centering
\includegraphics[scale=0.3]{figures/cahyani8.jpg}
\caption{cahyani8}
\label{cahyani8}
\end{figure}
\par
